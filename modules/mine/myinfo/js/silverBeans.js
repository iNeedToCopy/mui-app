...
var container = new Vue({
	...
	methods:{
		reset:function(){
			...
			this.mysilvergrade = '';
			this.mysilverdesc = '';
			this.mytopshareuname = '';
		},
		goto_recharge:function(){
			app.show_webview_fire('recharge','active',{type: '银豆'});
		},
		goto_member:function(){
			app.show_webview_fire('url_view','goto_url',{url:this.url});
		},
		load_info:function(){
			var _self = this;
			setTimeout(function(){
				app.http_get("/silver/home",function(ret){
					_self.isloading = false;
					_self.mysilverdesc = ret.data.mysilverdesc;
					_self.mysilver = ret.data.mysilver;
					_self.mysilvergrade = ret.data.mysilvergrade;
					_self.mysilvershare = ret.data.mysilvershare;
					_self.mytopshareuname = ret.data.mytopshareuname;
					_self.url = ret.data.url;
				...
				},function(x,t,e){_self.isloading = false;mui.toast('服务器异常')});
			},200);
		...
		goto_beansDetail: function(){
			var v = app.show_webview_fire("beansDetail",'loadinfo',{url:'/silver/detail'});
		},
		//兑换历史
		goto_exchangeHistory:function(){
			app.show_webview_fire("exchangeHistory","loadinfo",{url:'/silver/history'});
		},
		//兑换商品详情
		goto_exchangeDetail:function(_id){
			var exchange_url = {
				exchangeUrl:'/silver/exchange',
				payUrl:'/silver/exchange/pay'
			}
			app.show_webview_fire("exchangeDetail","loadinfo",{id:_id,url:'/silver/goods/home?goodsid=',exchange_url:exchange_url});
		},
